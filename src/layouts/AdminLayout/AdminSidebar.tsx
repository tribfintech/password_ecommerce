...
export default function AdminSidebar({ isOpenSidebar, onCloseSidebar }: AdminSidebarProps) {
  const { pathname } = useLocation();
  const AuthAdmin = useSelector((state: RootState) => state.AuthAdmin);
  const { user } = AuthAdmin;
    ...
    >
      ...
      >
        ...
        {isCollapse ? (
          ...
          <Link underline="none" component={RouterLink} to={PATH_ADMIN.general.profile}>
            <AccountStyle>
              <MyAvatar />
              <Box sx={{ ml: 2 }}>
