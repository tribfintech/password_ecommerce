...
const CompanyNewGroup: React.FC = () => {
  ...
  async function getPermissionsList() {
    const endpoint = `${process.env.REACT_APP_BASE_URL}${endpoints.integrator.permissions}`;
  ...
  async function callEdit() {
    const endpoint = `${process.env.REACT_APP_BASE_URL}${endpoints.integrator.groups}/${params.id}`;
    setLoading(true);
    setTypePage('Edit');
...
export default CompanyNewGroup;
