...
const NewGroup: React.FC = () => {
  ...
  async function getPermissionsList() {
    const endpoint = `${process.env.REACT_APP_BASE_URL}${endpoints.administrative.permissions}`;
  ...
  async function callEdit() {
    const endpoint = `${process.env.REACT_APP_BASE_URL}${endpoints.administrative.groups}/${params.id}`;
    setLoading(true);
    setTypePage('Edit');
