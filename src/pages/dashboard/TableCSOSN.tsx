...
export default function TableCSOSN() {
  ...
  const filteredType = applySortFilter(products, filterName);

  const isTypeNotFound = filteredType.length === 0;
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          links={[
            ...
            {
              name: 'Tabela de NCM',
              href: PATH_DASHBOARD.tables.tableNCM
            },
                    ...
                    .map((row) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell style={{ minWidth: 550 }}>Alguma descrição</TableCell>
