...
mock.onGet('/api/company/profile').reply(() => {
  const profile = {
    id: mockData.id(1),
...
mock.onGet('/api/company/all').reply(() => {
...
mock.onGet('/api/company/manage-companies').reply(() => {
  const companies = [...Array(24)].map((_, index) => ({
    id: mockData.id(index),
    avatarUrl: mockData.image.avatar(index),
    name: mockData.name.fullName(index),
...
mock.onGet('/api/company/social/followers').reply(() => {
...
mock.onGet('/api/company/social/friends').reply(() => {
...
mock.onGet('/api/company/social/gallery').reply(() => {
...
mock.onGet('/api/company/account/cards').reply(() => {
...
mock.onGet('/api/company/account/address-book').reply(() => {
...
mock.onGet('/api/company/account/invoices').reply(() => {
...
mock.onGet('/api/company/account/notifications-settings').reply(() => {
  const notifications = {
...
mock.onGet('/api/company/posts').reply(() => {
